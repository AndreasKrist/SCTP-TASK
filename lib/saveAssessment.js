...
export async function saveAssessment({ biodata, selectedRole, results, sessionQuestions, answers, durationSeconds, shuffledOptionsMap, videoUrl, tabViolations }) {
  ...
  const data = {
    ...
    // Shuffled option display order (so admin/PDF can show same order as test-taker saw)
    shuffledOptionsMap: shuffledOptionsMap || {},

    // Video recording URL (Firebase Storage)
    videoUrl: videoUrl || null,

    // Anti-cheat: number of times user left the tab/app during assessment
